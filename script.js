...
$(document).ready(function () {
  ...
  $("body").on("click", ".close", function () {
    for (var i = 1; n >= i; i++) {
      if ($(this).attr("title") == "ele" + i) {
        if (mod == 12) {
          $(".sub-element-" + i).addClass("hide");
          var num1 = getObjectValue(box1lis, "sub-element-" + i);

          if (num1 != null) {
            box1(num1, "Accessories-" + i);
          } else {
            var num2 = getObjectValue(box2lis, "sub-element-" + i);
            box2(num2, "Accessories-" + i);
          }
        } else {
          $(".sub-element-" + i).addClass("hide");
          var num = getObjectValue(customerRequirement, "sub-element-" + i);
          otherBox(num, "Accessories-" + i);
        }
      }
    }
  });
...
function switch4InnerSwitches(n) {
  $(".sub-element-" + n).html(
...
function switch4fan1InnerSwitch(n) {
  $(".sub-element-" + n).html(
...
function switch6fan1InnerSwitch(n) {
  $(".sub-element-" + n).html(
